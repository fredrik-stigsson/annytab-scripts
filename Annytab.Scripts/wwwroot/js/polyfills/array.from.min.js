// From: https://polyfill.io/v3/polyfill.min.js?flags=always,gated&features=Array.from
(function (undefined) {
    ...
    )) { CreateMethodProperty(Object, "freeze", function e(r) { return r }); } if (!("getOwnPropertyDescriptor" in Object && "function" == typeof Object.getOwnPropertyDescriptor && function () {
        try {
            var t = {}
