// From: https://polyfill.io/v3/polyfill.min.js?flags=always,gated&features=Element.prototype.remove
(function (undefined) {
    if (!("document" in this
    ...
    )) { Document.prototype.remove = Element.prototype.remove = function e() { this.parentNode && this.parentNode.removeChild(this) }, "Text" in this && (Text.prototype.remove = Element.prototype.remove); }
